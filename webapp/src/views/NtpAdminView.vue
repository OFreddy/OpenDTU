    ...
    <BasePage :title="$t('ntpadmin.NtpSettings')" :isLoading="dataLoading || timezoneLoading">
        ...
        <form @submit="saveNtpConfig">
            ...
            <CardElement :text="$t('ntpadmin.Deepsleep')" textVariant="text-bg-primary" add-space>
                <div class="row mb-3">
                    <label class="col-sm-2 form-check-label" for="inputDeepsleep">{{
                        $t('ntpadmin.EnableDeepsleep')
                    }}</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <label for="inputDeepsleeptime" class="col-sm-2 col-form-label">{{
                        $t('ntpadmin.DeepsleepTime')
                    }}</label>
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            />
                            <span class="input-group-text" id="deepsleeptimeDescription">{{
                                $t('ntpadmin.Seconds')
                            }}</span>
                        </div>
                    </div>

    ...
    computed: {
        ...
        versionInfoUrl(): string {
            if (this.systemStatus.git_is_hash) {
                return 'https://github.com/Ofreddy/OpenDTU/commits/' + this.systemStatus.git_hash;
            }
            return 'https://github.com/Ofreddy/OpenDTU/releases/tag/' + this.systemStatus.git_hash;
        }
    },
});
</script>
